...
args["TEST_DIRECTORY"] = "../../lrs3/" + "trainval/"
args["TEST_SIZE"] = 1000
args["TEST_SET"] = "test"
args["PRETRAIN_SET"] = "pretrain"
args["PRETRAIN_SET_SIZE"] = 2000
...
args["TRAINED_MODEL_FILE"] = "../../pre_models/pre_models/audio-only.pt"   #relative path to the trained model file
